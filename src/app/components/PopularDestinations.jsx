      ...
      try {
        ...
        const data = {
          cruises: {
            ...
            bgGradient: "from-blue-900/20 via-cyan-900/10 to-teal-900/20",
            accentColor: "blue",
            items: []
          },
          hotels: {
            ...
            bgGradient: "from-purple-900/20 via-pink-900/10 to-rose-900/20",
            accentColor: "purple",
            items: []
          },
          packages: {
            ...
            bgGradient: "from-orange-900/20 via-red-900/10 to-pink-900/20",
            accentColor: "orange",
            items: []
          }
        };
        ...
        <div className="relative mx-auto max-w-[1600px] px-6 sm:px-8 lg:px-12">
          ...
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-xl bg-cyan-600 px-8 py-4 text-lg font-semibold text-white hover:bg-cyan-700 transition"
            >
              Try Again
            </button>
          </div>
  ...
  return (
    <section className="relative py-32 bg-gradient-to-br from-gray-900 via-black to-gray-900 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-20 w-96 h-96 bg-gradient-to-br from-blue-500/10 to-purple-500/5 animate-morphing-blob blur-3xl"></div>
        <div className="absolute bottom-20 right-20 w-80 h-80 bg-gradient-to-br from-pink-500/10 to-orange-500/5 animate-liquid-morph blur-2xl"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-gradient-to-br from-cyan-500/8 to-teal-500/5 animate-morphing-blob blur-2xl" style={{animationDelay: '10s'}}></div>

        {/* Floating Particles */}
        <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-blue-400/60 rounded-full animate-particle-float-1"></div>
        <div className="absolute top-3/4 right-1/3 w-3 h-3 bg-purple-400/70 rounded-full animate-particle-float-2"></div>
        <div className="absolute bottom-1/3 left-2/3 w-1.5 h-1.5 bg-pink-400/80 rounded-full animate-particle-float-3"></div>
        <div className="absolute top-1/3 right-1/4 w-2.5 h-2.5 bg-cyan-400/60 rounded-full animate-particle-float-1" style={{animationDelay: '2s'}}></div>
      </div>
      ...
      <div className="relative mx-auto max-w-[1600px] px-6 sm:px-8 lg:px-12">
        ...
        <header className="text-center mb-20 animate-fade-in-up">
          <div className="flex items-center justify-center mb-8 space-x-4">
            ...
            <div className="flex items-center space-x-3 glass-morphism rounded-full px-8 py-4 border border-cyan-400/30 animate-neon-glow text-cyan-400">
                      ...
                      <div className="relative">
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex-1">
                            <h4 className="text-xl font-bold text-white group-hover/item:text-cyan-300 transition-colors duration-300 mb-2">
                              {item.title}
                            </h4>
        ...
        <div className="mt-32 text-center animate-fade-in-up-delayed-2">
          <div className="glass-morphism rounded-3xl p-12 border-2 border-cyan-400/20">
            <Crown className="w-16 h-16 text-cyan-400 mx-auto mb-6 animate-float" />
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link
                href="/search"
                className="group relative bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-400 hover:to-purple-400 text-white font-black px-12 py-5 rounded-2xl transition-all duration-500 transform hover:scale-110 hover:shadow-2xl overflow-hidden"
              >
                <div className="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <span className="relative text-xl">Start Exploring</span>
              </Link>
              <button className="group glass-morphism hover:glass-morphism-dark border-2 border-white/20 hover:border-cyan-400/40 text-white font-black px-12 py-5 rounded-2xl transition-all duration-500 transform hover:scale-105">
